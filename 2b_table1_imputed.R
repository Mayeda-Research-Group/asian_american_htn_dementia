...
p_load("here", "tidyverse", "labelled", "table1", "openxlsx")
...
write.xlsx(
  ...
  rowNames = TRUE,
  file = here(
    "scripts", "output", "tables", "table_1_post_MI_cat_vars.xlsx"
  )
)
...
write.xlsx(
  tbl1_cont_post_mi_5 %>% as_tibble(rownames = "var"),
  file = here(
    "scripts", "output", "tables", "table_1_post_MI_cont_vars.xlsx"
  )
)
